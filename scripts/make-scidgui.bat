...
copy tcl\windows\stats.tcl + tcl\windows\tree.tcl + tcl\windows\crosstab.tcl + tcl\windows\pfinder.tcl + tcl\windows\tourney.tcl + tcl\windows\switcher.tcl + tcl\search\search.tcl + tcl\search\board.tcl + tcl\search\header.tcl 4

copy tcl\search\material.tcl + tcl\contrib\ezsmtp\ezsmtp.tcl + tcl\tools\email.tcl + tcl\tools\import.tcl + tcl\tools\optable.tcl + tcl\tools\preport.tcl + tcl\tools\pinfo.tcl + tcl\tools\analysis.tcl + tcl\tools\comp.tcl 5
...
copy 1 + 2 + 3 + 4 + 5 + 6 + 7 + tcl\misc\flags.tcl + tcl\tools\inputengine.tcl scinc.gui
