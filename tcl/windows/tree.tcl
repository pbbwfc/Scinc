...
proc ::tree::Open {{baseNumber 0}} {
  ...
  checkbutton $w.buttons.refresh -text [tr Refresh] -font font_Small \
...
proc ::tree::dorefresh { baseNumber } {
  ...
  if { ! $tree(autorefresh$baseNumber) || $::annotate(Engine) > -1 } {
    return
  }
...
#   This is done in backwards order for simplicity.
