...
proc nameEditor {} {
  ...
  foreach i {all filter} row {0 1} text {
    SelectAllGames
    SelectFilterGames
  } {
...
proc getCommandLineOptions {} {
  ...
  if { $::macOS && ([string first "-psn" [lindex $argv 0]] == 0)} {
    ...
    incr argc -1
  } elseif { $windowsOS && [string match "*scinc.gui" [lindex $argv 0]]} {
    # Remove "$PATH/scinc.gui" from argument list
    set argv [lrange $argv 1 end]
    incr argc -1
  }
...
#   .baseWin .glistWin .pgnWin .maintWin \
#   .ecograph .treeWin .analysisWin1 .anslysisWin2 \
#   .playerInfoWin .commentWin .repWin .statsWin .tbWin \
#   .sb .sh .sm .noveltyWin .oprepWin .plist \
