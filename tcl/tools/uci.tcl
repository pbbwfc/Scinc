...
namespace eval uci {
  ...
  proc processAnalysisInput { {n 1} {gui 1} } {
    global analysis annotate ::uci::uciInfo ::uci::optionToken 
  ...
  ### Called the AnalysisEngine toplevel
  ...
  proc saveConfig {n} {
    ...
    if {$n != -1} {
      ...
      ### Previously it was only done when user "OK"ed the parent widget
  ...
  ### Called by calvar.tcl tactics.tcl
