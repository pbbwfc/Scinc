...
proc ::enginelist::choose {} {
  ...
  dialogbutton $w.buttons.copy -textvar ::tr(EngineCopy) -command {
...
### this is used by all uci and xboard engines when open with their own window (eg F2)
